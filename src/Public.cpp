...
void CI_Logo()
{
	...
	printf("CCC             III\n");
	printf("CCC CCC         III\n");
	printf("CCC CCC         III\n"); //underline the Web Address and brown text
	printf(" CCCCC       IIIIIIIII   \033[4;33mhttp://ci-main.no-ip.org/\n"); 
	printf("\033[0m\n"); //reset all atributes back to normal
}
...
/*
* NAME: PROG_logo()
* PURPOSE: displays ASCII art for each program
* RETURNS: N/A
* PROVIDED BY: Andrew Malone
* DATE: 9/23/2015
*/
...
void rtgen_logo()
{
	...
	printf(" | |__) | | |______| |  __  ___ _ __\n");
	printf(" |  _  /  | |______| | |_ |/ _ \\ '_ \\\n");
	printf(" | | \\ \\  | |      | |__| |  __/ | | |\n");
	printf(" |_|__\\_\\ |_|       \_____|\\ ___|_| |_|\n\n");
}

void rcrack_logo()
{
	printf("");
	printf(" _____ _______      _____                _");
	printf("|  __ \\__   __|    / ____|              | |");
	printf("| |__) | | |______| |     _ __ __ _  ___| | __");
	printf("|  _  /  | |______| |    | '__/ _` |/ __| |/ /");
	printf("| | \\ \\  | |      | |____| | | (_| | (__|   <");
	printf("|_|__\\_\\ |_|       \\_____|_|  \\__,_|\\___|_|\\_\\");
}
/*
  _____ _______     _____            _           
 |  __ \__   __|   / ____|          | |          
 | |__) | | |_____| (___   ___  _ __| |_         
 ...
 |_|__\_\ |_|     |_____/ \___/|_|   \__|        
  ...
  _____ _______     _____                        
 |  __ \__   __|   |  __ \                       
 | |__) | | |______| |  | |_   _ _ __ ___  _ __  
 |  _  /  | |______| |  | | | | | '_ ` _ \| '_ \ 
 | | \ \  | |      | |__| | |_| | | | | | | |_) |
 |_|__\_\ |_|      |_____/ \__,_|_| |_| |_| .__/ 
                                          | |    
                                          |_|    

 ______ _______     _____ _        _             
 |  __ \__   __|   / ____| |      | |            
 | |__) | | |_____| (___ | |_ __ _| |_ ___       
 |  _  /  | |______\___ \| __/ _` | __/ __|      
 | | \ \  | |      ____) | || (_| | |_\__ \      
 |_|  \_\ |_|     |_____/ \__\__,_|\__|___/      
